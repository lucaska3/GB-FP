 ...
 * @author fp0520141051
 */
public class FrmCadAlu extends javax.swing.JFrame {
    ...
    public FrmCadAlu() throws ParseException {
        initComponents();
...
//        setFocusTraversalKeysEnabled(true);
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        try {
            ...
            Logger.getLogger(FrmCadAlu.class.getName()).log(Level.SEVERE, null, ex);
